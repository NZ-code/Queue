...
public:
    ...
    void delete_element(Node*& prev, Node*& cur) {
...
int convert_command(const std::string& cmd) {
    ...
    else if (cmd == "DEL_BEG") return 2;
    else if (cmd == "DEL_END") return 3;  
    else if (cmd == "PRINT_FORWARD") return 4;
    else if (cmd == "PRINT_BACKWARD") return 5;
    else if (cmd == "SIZE") return 6;
    else return -1;
}
...
int main()
{
    ...
    while (!std::cin.eof()) {
        ...
        case 4://PRINT_FORWARD  !
        {
            list->print_forward();
            break;
        }
        case 5://PRINT_BACKWARD     !
        {
            list->print_backward();
            break;
        }
